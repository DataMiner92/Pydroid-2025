...
class ECommerceGUI:
    def __init__(self, master):
        ...
        self.label = tk.Label(master, text="Welcome to ShopPro© E-Commerce System!")
        self.label.pack()
...
class ECommerceSystem:
    def __init__(self):
        self.products = [
            ...
            Product(4, 'Headphones', 200),
            Product(5, 'Smartwatch', 300),
            Product(6, 'PS-5', 2500),
            Product(7, 'Android TV', 1500),
            Product(8, '5G ASetbox', 1200),
            Product(9, 'BT Speaker', 500),
            Product(10, 'Laptop Bag', 200),
    ...
    def place_order(self):
        output = 'Order placed successfully! Thank you for shopping with us.'
        self.cart = Cart()
        return output
